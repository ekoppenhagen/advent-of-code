package io.github.ekoppenhagen.aoc.extensions.helpers

class StringHelpers {

    fun getAllNumbersIncludingSpelledOutOnes(string: String): List<String> {
    ...
    fun toArabicNumeral(number: String) =
